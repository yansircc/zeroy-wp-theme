...
class Zeroy_Theme_Updater {
    ...
    public function __construct() {
        ...
        $this->update_path = 'http://localhost:5174/api/theme-updates/check';
    ...
    private function get_remote_info() {
        $request = wp_remote_get('http://localhost:5174/api/theme-updates/info/' . $this->theme_slug);
    ...
    private function get_changelog() {
        $request = wp_remote_get('http://localhost:5174/api/theme-updates/changelog/' . $this->theme_slug);
